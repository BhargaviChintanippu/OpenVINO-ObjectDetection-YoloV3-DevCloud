...
def main():
    ...
    while cap.isOpened():
        ...
        frame_count += 1
        infer_times.append(det_time)
        
        print(sum(infer_times))
      
        progressUpdate(infer_file, (sum(infer_times)), frame_count, number_input_frames)
        ...
        with open(os.path.join(args.output_dir, 'stats.txt'), 'w') as f:
            f.write('{:.3g} \n'.format(sum(infer_times)))
            f.write('{} \n'.format(number_input_frames))        
    cap.release()
